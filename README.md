...
**GET** `https://localhost:5001/api/Authorization/authorize`

Используется для проверки авторизации пользователя.

### Регистрация нового пользователя  
**GET** `https://localhost:5001/api/Registration/register`

Предназначен для открытия формы регистрации (если предусмотрено).

## Работа с заявками (Applications)

### Отправка новой заявки  
**POST** `https://localhost:5001/api/Applications`

Пример тела запроса (Form-data или multipart/form-data):

```
FullName: Иванов Иван  
Email: ivanov@example.com  
Phone: 1234567  
ServiceType: Заказ канцелярских принадлежностей  
Description: Нужны ручки, блокноты и маркеры  
...
**GET** `https://localhost:5001/api/Applications/9a481c8c-f6a2-4479-8ac5-e71f4d05ee9d`

Позволяет получить подробную информацию о заявке по её идентификатору.

## Административные запросы (Admin)

### Получение всех заявок  
**GET** `https://localhost:5001/api/Admin/allapplications`

Возвращает список всех заявок без фильтрации.

### Фильтрация заявок  
**GET** `https://localhost:5001/api/Admin/applications?serviceType=Заказ%20канцелярских%20принадлежностей&status=New&fullName=петр&startDate=2025-04-21T09:22:50.989937`

Фильтрация заявок по типу услуги, статусу, имени заявителя и дате подачи.

### Обновление заявки (например, смена статуса)  
**PATCH** `https://localhost:5001/api/Admin/22281c54-da3f-44f6-9247-2ecec1ec5426`

Пример тела запроса (JSON):

```json
{
  "id": "22281c54-da3f-44f6-9247-2ecec1ec5426",
  "status": "Completed"
}
```

### Удаление заявки  
**DELETE** `https://localhost:5001/api/Admin/22281c54-da3f-44f6-9247-2ecec1ec5426`
